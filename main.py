...
# ===================== TENTANG =====================
    ...
    ### 🔬 Kode & Proses Eksperimen
    Aplikasi ini adalah demo dari model klasifikasi terbaik. Seluruh proses analisis, *preprocessing*, dan *training model* untuk **8 skenario uji coba** yang telah dijelaskan didokumentasikan secara rinci dalam *collection* notebook di Kaggle.

    ➡️ **[Lihat 8 Kaggle Notebook sesuai dengan Jumlah Skenario Uji Coba Penelitian di Kaggle Collection](https://www.kaggle.com/work/collections/16224530)**
